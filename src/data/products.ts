...
const ADDITIONAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 4500,
    description: "Heavyweight premium cotton polo shirt in clean white.",
    category: "polos",
    collection: "matrix-essentials",
    images: [
      "/images/tshirts/White-Polo-shirt.jpg",
      "/images/tshirts/Black-Polo-shirt.jpg",
    ],
    sizes: ["S", "M", "L", "XL"],
    colors: [
    ...
    details: ["Premium cotton pique", "Ribbed collar", "Relaxed fit"],
  ...
  {
    id: "local-black-polo",
    name: "Premium Black Polo Shirt",
    slug: "premium-black-polo-shirt",
    price: 4500,
    description: "Heavyweight premium cotton polo shirt in deep black.",
    category: "polos",
    collection: "matrix-essentials",
    images: [
      "/images/tshirts/Black-Polo-shirt.jpg",
  ...
  {
    id: "local-white-pants",
    name: "Essential White Pants",
    slug: "essential-white-pants",
    price: 6200,
    description: "Relaxed essential trousers in crisp white cotton twill.",
    category: "pants",
    collection: "matrix-essentials",
    images: ["/images/pants/white-pants.jpg", "/images/pants/mort-cargo-black.jpg"],
    sizes: ["30", "32", "34", "36"],
    colors: [
      { name: "White", hex: "#F5F5F0" },
      { name: "Black", hex: "#111111" },
    ],
    details: ["Relaxed straight fit", "Cotton twill", "Utility pockets"],
  ...
  {
    id: "local-white-shorts",
    name: "Essential White Shorts",
    slug: "essential-white-shorts",
    price: 4200,
    description: "Relaxed heavyweight shorts in clean white cotton.",
    category: "pants",
    collection: "matrix-essentials",
    images: [
  ...
  {
    id: "local-black-shorts",
    name: "Essential Black Shorts",
    slug: "essential-black-shorts",
    price: 4200,
    description: "Relaxed heavyweight shorts in washed black cotton.",
    category: "pants",
    collection: "matrix-essentials",
    images: [
      "/images/pants/Black-shorts.jpg",
