...
export const CATEGORIES: Category[] = [
  {
    ...
    slug: "hoodies",
    count: "12+ ITEMS",
    image: "/images/hoodies/hoodie-cat.jpg",
  },
  {
    id: "cat-2",
    name: "T-SHIRTS",
...
export const PRODUCTS: Product[] = [
  {
    ...
    collection: "oblivion",
    images: [
      "/images/hoodies/essential-hoodie.jpg",
      "/images/hoodies/mort-001-origin-hoodie.jpg",
      "/images/hoodies/mort-001-origin-zip-hoodie.jpg",
      "/images/hoodies/mort-hoodie-model.jpg",
    ],
    sizes: ["S", "M", "L", "XL"],
    colors: [
  ...
  },
  {
    ...
    images: [
      "/images/hoodies/mort-001-origin-zip-hoodie.jpg",
      "/images/hoodies/mort-hoodie-black-front.jpg",
      "/images/hoodies/mort-hoodie-black-back.jpg",
    ],
    sizes: ["S", "M", "L", "XL"],
