...
const ADDITIONAL_PRODUCTS: Product[] = [
  {
    ...
    images: ["/images/tshirts/White-Polo-shirt.jpg"],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    category: "polos",
    collection: "matrix-essentials",
    images: ["/images/tshirts/Black-Polo-shirt.jpg"],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    category: "pants",
    collection: "matrix-essentials",
    images: ["/images/pants/white-pants.jpg"],
    sizes: ["30", "32", "34", "36"],
    colors: [{ name: "White", hex: "#F5F5F0" }],
  ...
  },
  {
    ...
    category: "pants",
    collection: "matrix-essentials",
    images: ["/images/pants/White-shorts.jpg"],
    sizes: ["S", "M", "L", "XL"],
    colors: [{ name: "White", hex: "#F5F5F0" }],
  ...
  },
  {
    ...
    category: "pants",
    collection: "matrix-essentials",
    images: ["/images/pants/Black-shorts.jpg"],
    sizes: ["S", "M", "L", "XL"],
    colors: [{ name: "Black", hex: "#111111" }],
    details: ["Heavyweight cotton", "Elastic waist", "Side pockets"],
    care: ["Machine wash cold", "Hang dry"],
  ...
  },
  {
    ...
    category: "pants",
    collection: "matrix-essentials",
    images: ["/images/pants/Wine-red-shorts.jpg"],
    sizes: ["S", "M", "L", "XL"],
    colors: [{ name: "Wine Red", hex: "#722F37" }],
    details: ["Heavyweight cotton", "Elastic waist", "Side pockets"],
    care: ["Machine wash cold", "Hang dry"],
    rating: 0,
    reviewsCount: 0,
  ...
  ...[
    ...
    ["White P Cap", "white-p-cap", "/images/accessories/white p-cap.jpg", 2800],
